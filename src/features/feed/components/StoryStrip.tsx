  ...
  return (
    <div className="feed-stories">
      <div className="feed-stories-row">
        <motion.button whileTap={{ scale: 0.9 }} className="story-item" type="button" aria-label="Create your story">
        ...
        {stories.map((story) => (
          <motion.button key={story.id} whileTap={{ scale: 0.9 }} className="story-item" type="button" aria-label={`Open ${story.author.displayName}'s story`}>
