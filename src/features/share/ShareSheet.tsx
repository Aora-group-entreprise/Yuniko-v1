...
export function ShareSheet({ postId, onClose }: { postId: string; onClose: () => void }) {
  ...
  async function systemShare() {
    ...
    try { await navigator.share({ title: "Yuniko", text: "Découvre ce post sur Yuniko", url: shareUrl }); } catch { /* cancelled */ }
  }
  ...
  return (
    <div className="share-sheet-backdrop" role="presentation" onMouseDown={onClose}>
      <motion.section
        ...
        className="share-sheet" role="dialog" aria-modal="true" aria-label="Partager"
